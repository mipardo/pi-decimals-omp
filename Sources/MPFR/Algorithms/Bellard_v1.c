 ...
 */
void bellard_iteration_v1_mpfr(mpfr_t pi, int n, mpfr_t m, mpfr_t a, mpfr_t b, mpfr_t c, mpfr_t d, 
 ...
 */
void bellard_algorithm_v1_mpfr(mpfr_t pi, int num_iterations, int num_threads, int precision_bits){
    mpfr_t jump; 
